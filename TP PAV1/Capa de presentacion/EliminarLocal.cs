...
namespace TP_PAV1
{
    public partial class EliminarLocal : Form
    {
        ...
        private void EliminarLocal_Load(object sender, EventArgs e)
        {
            cargarGrilla();
            cargarComboTipoLocal();
            btnEliminarLocal.Enabled = false;
            txtNombreLocal.Enabled = false;
            cmbTipoLocal.Enabled = false;
        }
        ...
        private bool EliminarLocalBD(Local l)
        {
            string cadenaConexion = System.Configuration.ConfigurationManager.AppSettings["cadenaTP1"];
            SqlConnection cn = new SqlConnection(cadenaConexion);
            ...
            {
                SqlCommand cmd = new SqlCommand();
                string consulta = "DELETE FROM locales_comerciales  WHERE nro_local like @numLocal";
                cmd.Parameters.Clear();
        ...
        private void grillaLocales_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
